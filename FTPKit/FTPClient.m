...
- (netbuf *)connect
{
   ...
   const char *user = _credentials.username != nil ? [_credentials.username cStringUsingEncoding:NSUTF8StringEncoding] : NULL;
   const char *pass = _credentials.password != nil ? [_credentials.password cStringUsingEncoding:NSUTF8StringEncoding] : NULL;
   netbuf *conn;
